...
class CursorSettingsComponent {
    ...
    private fun createPanel(): JPanel {
        ...
        val connectionTestPanel = JPanel(BorderLayout()).apply {
        ...
        return FormBuilder.createFormBuilder()
            ...
            .addSeparator()
            .addComponent(JBLabel("Advanced Settings").apply { 
    ...
    private fun setupListeners() {
        ...
        timeoutField.document.addDocumentListener(object : DocumentAdapter() {
    ...
    private fun testConnection() {
        ...
        ApplicationManager.getApplication().executeOnPooledThread {
            ...
            SwingUtilities.invokeLater {
                ...
                if (result.success) {
                    connectionDetailsArea.text = buildString {
    ...
    private fun updateConnectionStatus(success: Boolean, message: String, timestamp: Long) {
        connectionStatusLabel.text = if (success) {
            "✓ $message"
        } else {
            "✗ $message"
        }
